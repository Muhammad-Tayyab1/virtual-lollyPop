...
export default function Lolly({LollyTop, Lollymiddle, LollyBottom}) {
    ...
    <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Lolly">
            ...
            <use className="lollyBottom" fill={LollyTop} fillRule="nonzero" href="#path-1"></use>
            <rect className="lollyTop" fill={Lollymiddle} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9" width="224" height="134"></rect>
            <rect className="lollyMiddle" fill={LollyBottom} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113" width="224" height="111"></rect>
